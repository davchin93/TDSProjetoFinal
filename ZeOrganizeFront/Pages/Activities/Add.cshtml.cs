...
namespace ZeOrganizeFront.Pages.Activities
{
    public class Add : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(int id)
        {
            ...
            if (!ModelState.IsValid || !DatesAreValid)
            {
                if (!DatesAreValid)
                {
                    ModelState.AddModelError("DatesAreValid", "Os hor�rios das atividades devem estar entre o in�cio e final do evento.");
                }
